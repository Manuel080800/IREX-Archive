...
def explain(data, model, config, expertKnowledge):
    ...
    ## data is explained.
    for individual_index in [0,1,-1]:
        print("Generation of the LIME explanation plot")
    ...
    ## data is explained.
    for individual_index in [0,1,-1]:
        print("Generation of the SHAP explanation plot")
    ...
    ## Identification of important variables from the randomness of the
    ...
    for iterable_class in range(0, len(config['name_class'])):
        ...
        ## map of the all class.
        print("Generation of the heat map of Important Variable by class.")
    ...
    ## Explainability of the data by means of the heat map of the all class.
    ...
    for iterable_class in range(0, len(config['name_class'])):
        ...
        ## Generation of the heat map.
        print("Generation of the heat map of SHAP by class.")
        ...
        ## Generation of the heat map.
        print("Generation of the SHAP average heat map by class.")
        plt.figure(figsize = (28,6))
    ...
    for iterable_class in range(0, len(config['name_class'])):
        print("Generation of the heat map of LIME by class.")
        plt.figure(figsize = (28,14))
        ...
        print("Generation of the LIME average heat map by class.")
        plt.figure(figsize = (32,6))
        sns.heatmap(map_class[iterable_class].transpose(), cmap="Reds",
                    cbar = False)
        sns.heatmap(map_class[iterable_class].transpose(), cmap="Blues",
    ...
    ## Data processing of the all class.
    for elements in range(0, len(config['name_class'])):
    ...
    for iterable_class in range(0, len(config['name_class'])):
        print("Generation of the heat map of ALE by class.")
        plt.figure(figsize = (28,6))
    ...
    for iterable_class in range(0, len(config['name_class'])):
        ...
        # Generation of the heat map.
        print("Generation of the heat map of all comparison methods.")
    ...
    while True:
        ...
        i = 0
        if data['iteration'] == 1:
            ## Elimination of list of conflicting questions declared
            ## in global variables.
            ...
            ## Elimination of the list of anomadic questions defined in the
            ## improvement process.
        ...
        metrics = [",".join(map(str, ds_delete['Question'].tolist())),
                   accuracy, clf_rep[0][0], clf_rep[1][0],
                   clf_rep[2][0], clf_rep[3][0],clf_rep[0][1],
                   clf_rep[1][1], clf_rep[2][1], clf_rep[3][1],
                   clf_rep[0][2], clf_rep[1][2], clf_rep[2][2],
                   clf_rep[3][2]]

        ## The names of the columns of the dataset are defined.
        columns = ['Question','Acurracy global','Precision_0','Recall_0',
                   'F1_score_0', 'Support_0', 'Precision_1','Recall_1',
                   'F1_score_1', 'Support_1','Precision_2','Recall_2',
                   'F1_score_2','Support_2']
        ...
        ## The anomalous questions present in the model are determined
        ...
        ## We proceed to identify the anomadic questions present in
        ...
        ## We proceed to eliminate the identified anomadic questions
        ...
        if config['selection_mode'] == 2:
            ## Questions that fail in classes defined with the
        ...
        if config['selection_mode'] == 4:
            ## Out-of-threshold questions are retrieved in
        ...
        ## Generation of the heat map.
        print("Generation of the heat map of Important" +
    ...
    for x in range(dd.shape[0]):
        ...
        ## The total number of questions eliminated in each iteration
        ## is obtained.
        if x == 0:
        ...
        ## The recall of the Low, Medium and High classes of each iteration
        ## is obtained.
